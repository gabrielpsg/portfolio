...
(function() {
	var $body = document.body
	, $menu_trigger3 = $body.getElementsByClassName('menu-trigger3')[0];

	if ( typeof $menu_trigger3 !== 'undefined' ) {
		$menu_trigger3.addEventListener('click', function() {
			$body.className = ( $body.className == 'menu-active3' )? '' : 'menu-active3';
		});
	}
...
(function() {
	var $body = document.body
	, $menu_trigger4 = $body.getElementsByClassName('menu-trigger4')[0];

	if ( typeof $menu_trigger4 !== 'undefined' ) {
		$menu_trigger4.addEventListener('click', function() {
			$body.className = ( $body.className == 'menu-active4' )? '' : 'menu-active4';
		});
	}
...
(function() {
	var $body = document.body
	, $menu_trigger5 = $body.getElementsByClassName('menu-trigger5')[0];

	if ( typeof $menu_trigger5 !== 'undefined' ) {
		$menu_trigger5.addEventListener('click', function() {
			$body.className = ( $body.className == 'menu-active5' )? '' : 'menu-active5';
		});
	}
